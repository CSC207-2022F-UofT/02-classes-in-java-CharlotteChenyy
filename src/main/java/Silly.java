...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param first the first word for this Silly instance's name.
     * @param second the second word for this Silly instance's name.
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        int len_t = this.name.length();
        int len_o = other.name.length();
